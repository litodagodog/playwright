...
test('Sodium Levels', async () => {
  ...
  function formatDate(date) {
    ...
    await page.getByRole('cell', { name: 'Updated Delerium notes using playwright automation' }).first().isVisible();
    ...
    await page.getByTestId('ErrorIcon').isVisible();
    //DELETE SODIUM LEVEL
    await page.getByRole('row', { name: 'Updated Delerium notes using playwright automation' }).first().locator('#fade-button').click();
    ...
    await page.getByRole('cell', { name: 'Updated Delerium notes using playwright automation' }).first().isHidden();
